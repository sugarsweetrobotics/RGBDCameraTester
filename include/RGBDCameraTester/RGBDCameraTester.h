...
#ifndef RGBDCAMERATESTER_H
#define RGBDCAMERATESTER_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  RGBDCameraTester(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void RGBDCameraTesterInit(RTC::Manager* manager);
};

#endif // RGBDCAMERATESTER_H
